...
public class WebServer {
    ...
    private static class StaticFileHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            File staticFile = new File(ScreenshotUploader.getPluginFolder().toFile(), path);
    ...
    private static class GetCommentsHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if (matcher.matches()) {
                String filename = matcher.group(1);
                Path commentFile = Paths.get("./screenshotUploader/screenshots/" + filename.replaceFirst("(?i)\\.(png|jpg|jpeg|gif|bmp|webp)$", ".json"));
