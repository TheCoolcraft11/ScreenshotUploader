...
public class ScreenshotUploaderServer implements DedicatedServerModInitializer {
            ...
            context.server().execute(() -> {
                ...
                switch (deletionType) {
                    case "deleteOP" -> {
                        ...
                        Path jsonFile = BASE_DIR.resolve(filename.replaceFirst("(?i)\\.(png|jpg|jpeg|gif|bmp|webp)$", ".json"));
                        try {
    ...
    private void onServerStarting(MinecraftServer server) {
        ...
        copyResourceToServerDir("/static/js/shortener.js", "screenshotUploader/static/js/shortener.js");
        copyResourceToServerDir("/static/css/shortener.css", "screenshotUploader/static/css/shortener.css");
    }
